...
public class EventSource {
     ...
     * @param listener
     */
    public void addListener(final IEventType eventType,
     ...
     */
    public void addListener(final IEventType eventType,
                            final IEventListener listener, boolean weakReference) {
        ...
        try {
            ...
            if (!weakReference) {
                ...
                if (lstns == null) {
                    lstns = Collections.newSetFromMap(
     ...
     * @param listener  监听者
     */
    public void removeListener(final IEventType eventType,
                               final IEventListener listener) {
     ...
     * @param event
     */
    private void notifycation(final Event event,
                              Map<IEventType, Set<IEventListener>> listens,
                              boolean isWeak) {
        try {
     ...
     * @param chain
     */
    public void notifyListeners(final IEventType eventType, final boolean chain,
                                final Object data) {
     ...
     * @param eventType
     */
    public void notifyListenners(final IEventType eventType,
                                 final Object data) {
...
//
     ...
     * @param listener  监听者
     */
    public void addVoteListener(final IEventType eventType,
                                final IVoteEventListener listener) {
     ...
     * @param listener  监听者
     */
    public void removeVoteListener(final IEventType eventType,
                                   final IVoteEventListener listener) {
        if (voteListeners == null) {
            return;
        }
        try {
            this.vLock.writeLock().lock();
            Collection<IVoteEventListener> lstns = this.voteListeners
                    .get(eventType);
            if (lstns != null) {
                lstns.remove(listener);
            }
